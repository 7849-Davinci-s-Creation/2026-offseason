...
public class Telemetry {
    ...
    private final MechanismLigament2d[] moduleSpeeds = new MechanismLigament2d[] {
        m_moduleMechanisms[0].getRoot("RootSpeed", 0.5d, 0.5d).append(new MechanismLigament2d("Speed", 0.5d, 0)),
        m_moduleMechanisms[1].getRoot("RootSpeed", 0.5d, 0.5d).append(new MechanismLigament2d("Speed", 0.5d, 0)),
        m_moduleMechanisms[2].getRoot("RootSpeed", 0.5d, 0.5d).append(new MechanismLigament2d("Speed", 0.5d, 0)),
        m_moduleMechanisms[3].getRoot("RootSpeed", 0.5d, 0.5d).append(new MechanismLigament2d("Speed", 0.5d, 0)),
    };
    /* A direction changing and length constant ligament for module direction */
    private final MechanismLigament2d[] moduleDirections = new MechanismLigament2d[] {
        m_moduleMechanisms[0].getRoot("RootDirection", 0.5d, 0.5d)
            .append(new MechanismLigament2d("Direction", 0.1d, 0, 0, new Color8Bit(Color.kWhite))),
        m_moduleMechanisms[1].getRoot("RootDirection", 0.5d, 0.5d)
            .append(new MechanismLigament2d("Direction", 0.1d, 0, 0, new Color8Bit(Color.kWhite))),
        m_moduleMechanisms[2].getRoot("RootDirection", 0.5d, 0.5d)
            .append(new MechanismLigament2d("Direction", 0.1d, 0, 0, new Color8Bit(Color.kWhite))),
        m_moduleMechanisms[3].getRoot("RootDirection", 0.5d, 0.5d)
            .append(new MechanismLigament2d("Direction", 0.1d, 0, 0, new Color8Bit(Color.kWhite))),
    };
    ...
    public void telemeterize(SwerveDriveState state) {
        ...
        driveOdometryFrequency.set(1.0d / state.OdometryPeriod);
